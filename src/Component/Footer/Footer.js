...
const Footer = ({Supplier, Brand, Product, Groups, Products}) => {
    return (
        <div>
            <ul className='absolute inset-x-0 bottom-0 static '>
            <li className='btn  btn-primary p-2 m-2 '> <input type="radio" name="radio-1" className="radio radio-accent"  checked/>{Brand.length} </li>
      <li  className='btn btn-primary p-2 m-2 '> <input type="radio" name="radio-2" className="radio radio-accent" checked />{Supplier.length} </li>
      <li  className='btn btn-primary p-2 m-2 '> <input type="radio" name="radio-3" className="radio radio-accent" checked />{Product.length} </li>
      <li  className='btn btn-primary p-2 m-2 '> <input type="radio" name="radio-6" className="radio radio-accent" checked />{Groups.length} </li>
      <li  className='btn btn-primary p-2 m-2 '> <input type="radio" name="radio-5" className="radio radio-accent" checked />{Products.length} </li>
            </ul>
             <div className='absolute fixed inset-x-0 bottom-0 h-16'>
