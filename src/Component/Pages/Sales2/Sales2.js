      ...
      <div className="flex p-6 m-6  w-5/5 border">
        ...
        {/* table data  */}
          <div class="overflow-x-auto " style={{'height':'350px'}}>
            <table class="table bg-primary table-compact table-zebra w-full" >
        ...
        <div className="w-1/5 border text-left p-2 ">
          ...
          <p class="stat-value text-secondary text-2xl bg-info text-black p-2 ">Paid Amound: {payamount}</p>
          <p class="stat-value text-secondary text-red-500 text-2xl bg-success text-black p-2">Change Amound: {cnageamound}</p>
