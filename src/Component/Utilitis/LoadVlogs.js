...
const LoadVlogs = () => {
    return (
        <div className='flex mx-auto'>
            <div role="status" className="p-4 max-w-sm rounded border border-gray-200 shadow animate-pulse md:p-6 dark:border-gray-700 mx-auto">
